...
def generate_initial_prompt():
    return (
        '''
        The goal of this task is to rate the generated cyber grooming chat. Please take the time to fully understand the chat and the following question. Make sure to answer all sub questions without
any exceptions. Make sure to decrease your rating based on the types and number of errors in each chat. Give only an evaluation score without any additional explanation.
        '''
    )
...
def generate_question_prompt():
    return (
        "How relevant is the chat to the prompt? (on a scale of 1-5, with 1 being the lowest). Consider the following\n"
        "Did the model follow the prompt instructions? (e.g. length of the chat).\n"
        "Did the model output all necessary information? (e.g.presence or absence of specified cyber grooming features or strategies)."
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate prompt relevance of chats generated by a specific language model using text-davinci-003.")
    ...
    save_evaluations_to_csv(evaluations, args.model, "Prompt Relevance")
